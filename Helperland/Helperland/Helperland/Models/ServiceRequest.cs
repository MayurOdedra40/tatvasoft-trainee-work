...
namespace Helperland.Models
{
    ...
    public partial class ServiceRequest
    {
        ...
        //[Range(typeof(DateTime), Convert.ToString(DateTime.Now), "1/1/2020")]
        ...
        [NotMapped]
        public string ExtraService3 { get; set; }

        [NotMapped]
        public string ExtraService4 { get; set; }

        [NotMapped]
        public string ExtraService5 { get; set; }
        ...
        [NotMapped]
        [Required(ErrorMessage ="Please check the Terms and Policy")]
